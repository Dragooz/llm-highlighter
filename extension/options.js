...
function saveSettings() {
  const settings = {
    backendUrl: document.getElementById('backend-url').value.trim() || DEFAULT_BACKEND_URL,
    systemPrompt: document.getElementById('system-prompt').value.trim() || DEFAULT_SYSTEM_PROMPT,
